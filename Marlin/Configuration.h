 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 415 } //MEK Bondtech BMG 3:1 (415)
...
#define INVERT_X_DIR true   //MEK
#define INVERT_Y_DIR true   //MEK
#define INVERT_Z_DIR true   //MEK

// @section extruder

// For direct drive extruder v9 set to true, for geared extruder set to false.
#define INVERT_E0_DIR false   //MEK
